...
checkpoint_path="/data/shresth/opendvla-checkpoints/prism-dinosiglip-224px+mx-rt_1_16_depth_replace_dino"
checkpoint_path=$1
...
EvalOverlay() {
# A0
python simpler_env/main_inference.py --policy-model ${policy_model} --ckpt-path ${checkpoint_path} \
