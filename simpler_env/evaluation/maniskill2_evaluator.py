...
from simpler_env.utils.env.observation_utils import get_image_from_maniskill2_obs_dict, get_image_and_depth_from_maniskill2_obs_dict
...
def maniskill2_evaluator(model, args, depth_model=None):
                ...
                if args.obj_variation_mode == "xy":
                    for obj_init_x in args.obj_init_xs:
                        for obj_init_y in args.obj_init_ys:
                            if "opendvla" not in args.policy_model:
                                ...
                                success_arr.append(
                                    depth_run_maniskill2_eval_single_episode(
                                        obj_init_x=obj_init_x,
                                        obj_init_y=obj_init_y,
                    ...
                    for obj_episode_id in range(args.obj_episode_range[0], args.obj_episode_range[1]):
                        if "opendvla" not in args.policy_model:
                            ...
                            success_arr.append(depth_run_maniskill2_eval_single_episode(obj_episode_id=obj_episode_id, depth_model=depth_model, **kwargs))
                else:
                    raise NotImplementedError()

    return success_arr

def depth_run_maniskill2_eval_single_episode(
    model,
    ckpt_path,
    robot_name,
    env_name,
    ...
    print('building maniskill environment....')
    env = build_maniskill2_env(
        env_name,
        **additional_env_build_kwargs,
        **kwargs,
